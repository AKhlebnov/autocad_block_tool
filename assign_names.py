...
try:
    ...
    print("   Убедитесь, что AutoCAD запущен и открыт нужный чертёж.\n")
...
print(f'Обработано блоков - {blocks_found} шт.')   # исправлено: добавлен f
...
# ------------------------------------------------------------
# 10. Ожидание перед закрытием (для exe)
# ------------------------------------------------------------
